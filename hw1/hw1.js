...
const Product = class Product {
    ...
    static printProducts = (products) => {
        ...
        products.forEach(element => {
            ...
            const usdPrice = usdFormat.format(products.price);
            console.log(`Product: ${products.name}, Cost: ${usdPrice}, Available: ${stockAvailability}`);
        });*/
        products.forEach(product => {
            const stockAvailability = product.availability === 'In Stock' ? 'Yes' : 'No';
            console.log(`Product: ${product.name}, Cost: $${product.price.toFixed(2)}, Availability: ${stockAvailability}`);
          });
